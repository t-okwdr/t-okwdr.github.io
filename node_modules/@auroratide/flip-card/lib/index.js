...
export class FlipCardElement extends HTMLElement {
    ...
    set facedown(value) { this.toggleAttribute("facedown", value); }
    ...
    setFlipToFrontAnimation(keyframes, options) {
    ...
    setFlipToBackAnimation(keyframes, options) {
    ...
    #corners;
    connectedCallback() {
        this.#label = this.shadowRoot.querySelector("#side-label-text");
        this.#front = this.shadowRoot.querySelector(".front");
        this.#back = this.shadowRoot.querySelector(".back");
        this.#container = this.shadowRoot.querySelector(".container");
        this.#corners = this.shadowRoot.querySelectorAll(".corner");
...
const cssTimeToMs = (time) => parseFloat(time) * (time.endsWith("ms") ? 1 : 1000);
